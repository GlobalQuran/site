        ...
        W = {
            ...
            _cornerActivated: function (a) {
                ...
                case "hard":
                    if (a.x > c - e) {
						...
						a.corner = "l";
						<!---- not flip last page -->
						if($(".sample-flipbook").turn("pages")==b.opts.next)
							return !1;	
					}
                    else return !1;
                    break;
                case "sheet":
					e1 = this.height()/2;					
					e=100;   
                    if (a.y < e1) a.corner += "t";
                    else if (a.y >= e1) a.corner += "b";
                ...
                case "sheet":
                    ...
                    f = function (a, d, f, g) {
                        ...
                        c.opts.gradients && (f[0] && (z.x = 100 - z.x), f[1] &&
                            (z.y = 100 - z.y), k["box-shadow"] = "0 0 0 rgba(0,0,0,0)", I.css(k), O(b.ashadow, j(B ? 100 : 0, D ? 0 : 100), j(z.x, z.y), [
                            [L, "rgba(0,0,0,0)"],
                            [0.8 * (1 - L) + L, "rgba(0,0,0,0)"],
            ...
            _showFoldedPage: function (a, b) {                
                ...
                if (c) {
                    ...
                    if (!f || !e.point || e.point.corner != a.corner) {						
						if (c = "hover" == e.status || "peel" == e.status || e.opts.turn.data().mouseAction ? a.corner : null, f = !1, "prevented" == s("start", this, [e.opts, c])) {
                    ...
                    if (b) {
						...
						if(a.corner=="br"  || a.corner=="bl"){							
							
							this.animatef({
								from: [d.x, d.y],
								to: [a.x, d.y],
							   from: [d.x,this.height()],
							   to: [a.x, this.height()],
							   duration: 500,
								frame: function (b) {
									a.x = Math.round(b[0]);
						...
						if(a.corner=="bl" || a.corner=="br")
							a.y=this.height();
						else
							a.y=0;
						if(a.corner=="bl" || a.corner=="tl")
							a.x+=25;
						if(a.corner=="tr" || a.corner=="br")
							a.x-=25;
						i._fold.call(this, a), 						
                ...
                if (b.point) {
                    var c = this,
                        ...
                        e = function () {
							<!---- book closing -->
							if(b.point.corner=="r"){		
								$(".sample-flipbook").css("background-image","url(pics/leftbookback.png),url(pics/rightbookback.png)");
							}
            ...
            _eventStart: function (a) {
                ...
                if (!b.corner && !b.disabled && !this.flip("isTurning") && b.opts.page == c.data().pagePlace[b.opts.page]) {
					...
					<!---------mouse click on right cover----------------- !>
					if(b.corner.corner=="r"){	
					$(".stackleft").hide();								
					$(".stackright").hide();
					$(".leftMenu").hide();							
						$(".sample-flipbook").css("background-image","url(pics/leftbookback.png)");
            ...
            _eventMove: function (a) {
                ...
                if (!b.disabled) if (a = t ? a.originalEvent.touches : [a], b.corner) {						
                        ...
                        b.corner.y = a[0].pageY - c.top;i._showFoldedPage.call(this, b.corner)
                    } else if (b.hover && !this.data().effect && this.is(":visible")) 
						if (a = i._isIArea.call(this, a[0])) {
							<!------mouse move on right cover-------------------- !>
							if(a.corner=="r"){									
								$(".sample-flipbook").css("background-image","url(pics/leftbookback.png)");
							}							
