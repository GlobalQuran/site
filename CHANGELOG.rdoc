...
* NEW: implemented turn4.js flip effects
* NEW: favicon has been changed
* NEW: logo design
* NEW: layout design
* NEW: gq.bind {} - added binds feature for attaching dynamic binds for apps and layout
...
* NEW: gq.next(); and gq.prev();
* CHANGED: gq.next* and gq.prev* all to gq.load._next* and gq.load._prev*
* CHANGED: gq.load() as gq.load.get(). 
